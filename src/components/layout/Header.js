  ...
  if (status === "authenticated") {
    return (
      <>
        <Link
          href={"/profile"}
          className="whitespace-nowrap hover:text-[#fac031] hover:underline"
        >
          Hello, {userName}
        </Link>
        <button
    ...
    <header>
      ...
      <div className="hidden md:flex items-center justify-between">
        <nav className="flex items-center gap-8 text-gray-500 font-semibold">
          ...
          <Link href={"/"} className="hover:text-[#fac031]">
            Home
          </Link>
          <Link href={"/menu"} className="hover:text-[#fac031]">
            Menu
          </Link>
          <Link href={"/about"} className="hover:text-[#fac031]">
            About
          </Link>
          <Link href={"/contact"} className="hover:text-[#fac031]">
            Contact
          </Link>
        </nav>
